                ...
                with ui.element('div').classes('card-header'):
                    with ui.row().classes('items-center justify-between w-full'):
                        ...
                        ui.button(
                            'View Dashboard',
                            icon='visibility',
                            on_click=lambda: ui.navigate.to(f'/org/{organization_id}/async/{tournament_id}')
                        ).classes('btn')
            ...
            async def load_settings():
                ...
                if container:
                    ...
                    with container:
                        ...
                        ui.label('Async Tournament Settings').classes('text-xl font-bold')
                        ui.label('Coming soon - use Organization Admin > Async Tournaments to edit').classes('text-secondary')
