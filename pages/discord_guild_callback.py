...
def register():
    ...
    async def discord_guild_callback(
        code: str = None, state: str = None, guild_id: str = None, error: str = None
    ):
        """
        ...
        base = BasePage.authenticated_page(title="SahaBot2 - Discord Server Linking")
        ...
        async def content(page: BasePage):
            ...
            with ui.element("div").classes("card text-center"):
                ...
                with ui.element("div").classes("card-body"):
                    ui.spinner(size="lg")
                    ui.label("Verifying permissions and creating link...").classes(
                        "mt-2"
                    )
            ...
            try:
                ...
                if guild:
                    ...
                    error_msg = error_messages.get(
                        error_code, "failed_to_link_discord_server"
                    )
