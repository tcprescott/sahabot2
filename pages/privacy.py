        ...
        async def content(page: BasePage):
            ...
            with ui.element('div').classes('card'):
                ...
                with ui.element('div').classes('card-body'):
                    ...
                    # Data Collection
                    ui.label('Information We Collect').classes('text-xl text-bold mt-4 mb-2')
                    ui.label('We collect the following information through Discord OAuth2:').classes('mb-2')
                    ...
                    # Data Usage
                    ui.label('How We Use Your Information').classes('text-xl text-bold mt-4 mb-2')
                    ui.label('We use your information to:').classes('mb-2')
                    with ui.element('ul').classes('list-disc ml-6 mb-4'):
                        with ui.element('li'):
                            ui.label('Authenticate and identify you within the application')
                        with ui.element('li'):
                            ui.label('Display your Discord profile information')
                        with ui.element('li'):
                            ui.label('Manage your organization memberships and permissions')
                        with ui.element('li'):
                            ui.label('Track and audit actions for security purposes')
                        with ui.element('li'):
                            ui.label('Provide tournament and randomizer preset functionality')

                    # Data Storage
                    ui.label('Data Storage and Security').classes('text-xl text-bold mt-4 mb-2')
                    ui.label(
                    ...
                    ui.label('Third-Party Services').classes('text-xl text-bold mt-4 mb-2')
                    ui.label('We integrate with the following third-party services:').classes('mb-2')
                    with ui.element('ul').classes('list-disc ml-6 mb-4'):
                        with ui.element('li'):
                    ...
                    with ui.element('ul').classes('list-disc ml-6 mb-4'):
                        ...
                        with ui.element('li'):
                            ui.label('Request deletion of your account and associated data')
                        with ui.element('li'):
                            ui.label('Opt-out of certain data collection (by not using the service)')
                    ...
                    # Changes to Policy
                    ui.label('Changes to This Policy').classes('text-xl text-bold mt-4 mb-2')
                    ui.label(
