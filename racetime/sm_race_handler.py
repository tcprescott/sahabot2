...
class SMRaceHandler(SahaRaceHandler):
    ...
    async def ex_varia(self, args, message):
        ...
        try:
            ...
            await self.send_message(f"VARIA seed generated! {result.url} (Hash: {result.hash_id})")
    ...
    async def ex_dash(self, args, message):
        ...
        try:
            ...
            await self.send_message(f"DASH seed generated! {result.url} (Hash: {result.hash_id})")
