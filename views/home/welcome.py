...
class WelcomeView:
    ...
    async def render(user: Optional[User] = None):
        ...
        with ui.element("div").classes("home-hero"):
            ui.label("Welcome to SahaBot2").style(
                "font-size: 2rem; font-weight: 700; margin-bottom: 1rem;"
            )
            ui.label("A modern Discord bot management platform.").style(
                "font-size: 1.2rem; margin-bottom: 1rem;"
            )
            ui.label("Log in with Discord to get started!").style(
            ...
            with ui.element("div").classes("card-body"):
                with ui.row().classes("gap-md"):
                    ...
                    with ui.column().classes("gap-xs"):
                        ...
                        ui.label("Monitor your bot activity and statistics").classes(
                ...
                with ui.row().classes("gap-md mt-1"):
                    ...
                    with ui.column().classes("gap-xs"):
                        ...
                        ui.label("Manage users and permissions").classes(
                            "text-dynamic-secondary"
                        )
                ...
                with ui.row().classes("gap-md mt-1"):
                    ...
                    with ui.column().classes("gap-xs"):
                        ...
                        ui.label("Customize your bot settings").classes(
                            "text-dynamic-secondary"
                        )
        ...
        with ui.element("div").classes("card mt-1"):
            ...
            with ui.element("div").classes("card-body"):
                ui.label(
                    "1. Click the user menu button (top right) to log in with Discord"
                ).classes("text-dynamic-secondary")
                ui.label(
                    "2. Use the hamburger menu (☰) to navigate between sections"
                ).classes("text-dynamic-secondary mt-1")
                ui.label(
                    "3. Explore the features available to you based on your permissions"
                ).classes("text-dynamic-secondary mt-1")
