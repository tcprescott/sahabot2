        ...
        with ui.element('div').classes('card'):
            with ui.element('div').classes('card-header'):
                with ui.row().classes('items-center justify-between w-full'):
                    ui.label(f'Registered Players ({len(registrations)})').classes('text-xl font-bold')
                    ui.button('Register Player', icon='person_add', on_click=open_register_dialog).classes('btn').props('color=primary')
            ...
            with ui.element('div').classes('card-body'):
                if not registrations:
                    ...
                    def render_actions(reg):
                        ...
                        ).classes('btn btn-sm').props('flat color=negative').tooltip('Unregister player')
