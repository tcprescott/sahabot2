"""
Async Qualifier Player History View.
...
class AsyncPlayerHistoryView:
    """View for a player's race history in an async qualifier."""

    def __init__(self, current_user: User, tournament: AsyncQualifier, player_id: int):
