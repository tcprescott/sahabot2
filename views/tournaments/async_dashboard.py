...
class AsyncDashboardView:
    ...
    async def _render_player_stats(
        self, races: list[AsyncTournamentRace], pools
    ):  # noqa: ARG002
    ...
    async def _render_pool_progress(
        self, races: list[AsyncTournamentRace], pools: list
    ):
    ...
    async def _render_races_content(
        self, races: list[AsyncTournamentRace], status_filter: str, sort_by: str
    ):
