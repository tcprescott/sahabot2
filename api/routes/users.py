...
@router.get(
    ...
    dependencies=[Depends(enforce_rate_limit), Depends(require_permission(Permission.ADMIN))],
...
@router.get(
    "/search",
    response_model=UserListResponse,
    dependencies=[Depends(enforce_rate_limit), Depends(require_permission(Permission.MODERATOR))],
...
async def search_users(
    ...
    Returns:
        UserListResponse: Matching users and total count
    """
    service = UserService()
