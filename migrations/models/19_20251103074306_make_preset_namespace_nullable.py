...
async def upgrade(db: BaseDBAsyncClient) -> str:
    return """
        ALTER TABLE `randomizer_presets` MODIFY COLUMN `namespace_id` INT COMMENT 'Namespace this preset belongs to (null for global presets)';
        ALTER TABLE `randomizer_presets` MODIFY COLUMN `namespace_id` INT COMMENT 'Namespace this preset belongs to (null for global presets)';
...
async def downgrade(db: BaseDBAsyncClient) -> str:
    return """
        ...
        ALTER TABLE `randomizer_presets` MODIFY COLUMN `namespace_id` INT NOT NULL COMMENT 'Namespace this preset belongs to';
        ALTER TABLE `randomizer_presets` MODIFY COLUMN `namespace_id` INT NOT NULL COMMENT 'Namespace this preset belongs to';"""
...
MODELS_STATE = (
    ...
    "0K/NQgdFhGYw0sSYil/+PjB99E15PefIKFGmUBLOE/JWhJp2ejTu9EjDXjkHMCW1Y67Rqz"
    "DAyKElO9zvZnlCR3f26aUH42AwCV+uJUekdH/Dn140NYVTUPrt2pfDF86MeciLz/9NyjRw"
    "7m+DrVzO7vEMLid5YQuC6RPM9WvXwkYOBo7nyFw1LDvrPpbb+YKn3m8K+2dtwBtcAqUTVv"
    "ciPKATVve0YnNxnyztqMgQsmK7zbbsLaPs6EDISXI8sexxZD24VW3el+AxrmPoFvg8todm"
    "iS85apsNeEV9P9ZFUuPeNOqqHtVsX9/f9Lr1m3Zjfv7d+KezzV3hnlb0iGLvtA/dKHbX1n"
    "VOJ2i0r6DMJ50vLPy/0avKA3PtZ99olpuRJV3GskfJraOhzqkjPMhAcCyLyMNW75nYkDpw"
    "cCN5elX0mPD0KulzFqdXESo9lxiFrmm4n3zUPTsYe/CeNvRmm0/ruqkH6M536sZvQE3gYc"
    "JZ6aAD8nryui8fLR3CvmccuZY3CT291BW7uAXJWr940Bpiv0VwU+qu4RgW/SR6naSDPBLw"
    "sQCIHN8xPodKkDfi6lIkpiUU5Pz7gSLxdTkdBY7kGDFR/ZSHo6ofqPAlAITAy1ziWI4VVf"
    "Mtp8tXcS8XZrpJl2826Ub7gfd6v/EV0euVDhRySGiPczIxKtUBOiu3azdwyXi6CtZHlbA+"
    "KsH6aN8dwXHrbr0vuGteyGiYSSEfzqiJYcXNTZ7aK6mdV9orqSu2SsW2MBu9wXmqGm95KY"
    "7I5oC9q8AoW+GQ7OjZ7A0CvJH012RXbwDey4y6bg4QVZFWjJNrHEMRZ55mjNoaZ1Co8l73"
    "3te+2SMriEONaU91SoV/p196MEVcZpnDtthi0cc6bN1T9QSjtHJELPahJET0uqgISNE1ao"
    "AYFO8mgBtx6QX5YXkQixPfEiKtynuru0xlo3ltOVNzm8HCv/4fNNbzig=="
)
