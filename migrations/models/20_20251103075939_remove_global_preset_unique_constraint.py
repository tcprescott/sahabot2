...
async def upgrade(db: BaseDBAsyncClient) -> str:
    return """
        ...
        ALTER TABLE `randomizer_presets` ADD INDEX `idx_randomizer__randomi_358748` (`randomizer`, `name`);"""


async def downgrade(db: BaseDBAsyncClient) -> str:
    return """
        ALTER TABLE `randomizer_presets` DROP INDEX `idx_randomizer__randomi_358748`;
...
MODELS_STATE = (
    ...
    "0K/NQgdFhGYw0sSYil/KfWBKhaDst4yScD6QtyJ0VCXjx2mnR4NOjzTIlXMAU1I75hq9Cg"
    "OMHFqyw/1ulid0dGefXnowDgaT8OVackRK9zf86UVTUzgFpd+ufTl84cyYh7z4/N+kTAPn"
    "/jbYyuXsHs/gcpIXtiCYPsFcv3YtbORg4HjuzFXDsrPuY7mdL3jq/aawf9YGvMElUDphdS"
    "/CAzphdU8rNhf3ydKRigwhK7bbbMveMsqODoScJMcTyx5H1oNb1eZ9CR7jOoZugc9je2iW"
    "+JKjttmAV9T3Y10kNe5No67qUc329f1Nr1u/aTfm59+Nfzrb3BXuaUWPKPZO+9CNYndtXe"
    "d0gkb7Csp80vnCwv8bvao8MNd+9o1muRlZ0mUse5TcOhrqnDrCgwwEx7KIPGz1nokNqQMH"
    "N5KnV0WPCU+vkj5ncXoVodJziVHomob7yUfds4OxB+9pQ2+2+bSum3qA7nynbvwG1AQeJp"
    "yVDjogryev+/LR0iHse8aRa3mT0NNLXbGLW5Cs9YsHrSH2WwQ3pe4ajmHRT6LXSTrIIwEf"
    "C4DI8R3jc6gEeSOuLkViWkJBzr8fKBJfl9NR4EiOERPVT3k4qvqBCl8CQAi8zCWO5VhRNd"
    "9yunwV93Jhppv0/WaTbrL+Ye0HXslCa+t+4yui1ysdKOSQ0B7nZGJUqgN0Vm7XbuCS8XQV"
    "rI8qYX1UgvXRvjuC49bdel9w17yQ0TCTQj6cURPDipubPLVXUjuvtFdSV2yVim1hNnqD81"
    "Q13vJSHJHNAXtXgVG2wiHZ0bPZGwR4I+mvya7eALyXGXXdHCCqIq0YJ9c4hiLOPM0YtTXO"
    "oFDlve69r32zR1YQhxrTnuqUCv9Ov/RgirjMModtscWij3XYuqfqCUZp5YhY7ENJiOh1UR"
    "GQomvUADEo3k0AN+LSC/LD8iAWJ74lRFqV91Z3mcpG89pypuY2g4V//T9TWvOK"
)
