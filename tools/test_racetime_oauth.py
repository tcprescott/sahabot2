...
def test_oauth_credentials(
    racetime_url: str, category: str, client_id: str, client_secret: str
):
    """
    ...
    print(
        f"Client Secret: {client_secret[:10]}..." if len(client_secret) > 10 else "***"
    )
    print(f"{'='*60}\n")
    ...
    try:
        ...
        if resp.status_code == 200:
            ...
            if resp.status_code == 401:
                ...
                print(
                    "3. OAuth2 application is not configured for 'client_credentials' grant type"
                )
                print("\nHow to fix:")
