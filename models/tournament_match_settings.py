...
if TYPE_CHECKING:
    from .match_schedule import Match
...
class TournamentMatchSettings(Model):
    ...
    submitted_by = fields.ForeignKeyField('models.User', related_name='tournament_settings_submissions')
    ...
    is_valid = fields.BooleanField(default=True)  # Set false if settings fail validation
