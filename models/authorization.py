...
class OrganizationRole(Model):
    ...
    organization = fields.ForeignKeyField(
        "models.Organization", related_name="roles", on_delete=fields.CASCADE
    )
...
class RolePolicy(Model):
    ...
    id = fields.IntField(pk=True)
    role = fields.ForeignKeyField(
        "models.OrganizationRole", related_name="policies", on_delete=fields.CASCADE
    )
    policy_statement = fields.ForeignKeyField(
        "models.PolicyStatement", related_name="role_links", on_delete=fields.CASCADE
    )
...
class UserPolicy(Model):
    ...
    user = fields.ForeignKeyField(
        "models.User", related_name="direct_policies", on_delete=fields.CASCADE
    )
    organization = fields.ForeignKeyField(
        "models.Organization", related_name="user_policies", on_delete=fields.CASCADE
    )
    policy_statement = fields.ForeignKeyField(
        "models.PolicyStatement", related_name="user_links", on_delete=fields.CASCADE
    )
