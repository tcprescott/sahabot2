...
Events are organized by domain area (users, organizations, etc.)
...
Note: Tournament-related events are defined in plugins.builtin.tournament.events.types
and re-exported via application.events.__init__ for backward compatibility.
"""
...
# ============================================================================
# Race Events (for async qualifiers)
# ============================================================================
