    ...
    def _render_body(self):
        ...
        with ui.column().classes('gap-2 mb-4'):
            ...
            with ui.row().classes('items-center gap-2'):
                ...
                DateTimeLabel.create(self.preset.updated_at, format_type='datetime', classes='text-sm')

            with ui.row().classes('items-center gap-2'):
                ui.icon('visibility' if self.preset.is_public else 'visibility_off', size='sm')
        ...
        yaml_content = yaml.dump(self.preset.settings, default_flow_style=False, sort_keys=False)
