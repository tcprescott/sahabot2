...
class RequestOrganizationDialog(BaseDialog):
    ...
    def _render_body(self):
        ...
        ui.label('Submit a request to create a new organization. A SUPERADMIN will review your request.').classes('text-sm text-secondary mb-4')
        ...
        with self.create_actions_row():
            ...
            ui.button('Submit Request', on_click=self._submit).classes('btn').props('color=positive')
