...
class EditPermissionDialog(BaseDialog):
    ...
    def _render_body(self):
        ...
        self.can_create_cb = ui.checkbox('Can Create Presets', value=self.permission.can_create)
        self.can_update_cb = ui.checkbox('Can Update Presets', value=self.permission.can_update)
        self.can_delete_cb = ui.checkbox('Can Delete Presets', value=self.permission.can_delete)
