    ...
    def render() -> None:
        ...
        with ui.element('footer').classes('footer'):
            ...
            with ui.row().classes('footer-links'):
                ...
                ui.link('GitHub Repository', 'https://github.com/tcprescott/sahabot2', new_tab=True).classes('footer-link')
                ui.label('•').classes('footer-separator')
                ui.link('Privacy Policy', '/privacy').classes('footer-link')
                ui.label('•').classes('footer-separator')
                ui.link('RaceTime.gg', 'https://racetime.gg', new_tab=True).classes('footer-link')
