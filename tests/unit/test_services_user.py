...
class TestUserService:
    ...
    async def test_update_user_permission(
        self, mock_event_bus, sample_user, admin_user
    ):
    ...
    async def test_deactivate_user(self, sample_user):
        ...
        # Deactivate user
        deactivated_user = await service.deactivate_user(user_id=sample_user.id)
    ...
    async def test_search_users(self, admin_user):
        ...
        service.user_repository.search_by_username = AsyncMock(
