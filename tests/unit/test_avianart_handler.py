...
class TestAvianartCommand:
    ...
    def mock_message(self):
        """Mock message data."""
        return {"user": {"id": "test_user_123", "name": "TestUser"}}
    ...
    @pytest.mark.asyncio
    async def test_ex_avianart_success(self, mock_handler, mock_message, mock_result):
        """Test successful Avianart seed generation."""
        with patch(
            "application.services.randomizer.avianart_service.AvianartService"
    ...
    @pytest.mark.asyncio
    async def test_ex_avianart_no_args(self, mock_handler, mock_message):
    ...
    @pytest.mark.asyncio
    async def test_ex_avianart_value_error(self, mock_handler, mock_message):
    ...
    @pytest.mark.asyncio
    async def test_ex_avianart_timeout(self, mock_handler, mock_message):
    ...
    @pytest.mark.asyncio
    async def test_ex_avianart_generic_exception(self, mock_handler, mock_message):
